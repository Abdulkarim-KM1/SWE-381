      ...
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <form action="#" class="form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
            <input type="text" class="form-control" placeholder="Pitch name">
            ...
            <div class="accordion accordion-flush" id="faqlist">
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Yes sure you can make multiple reservations at one time.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Check the discption of the pitch for any information, or if you have any questions you can ask in the message section while reserving.
                  </div>
                </div>
              </div><!-- # Faq item-->
